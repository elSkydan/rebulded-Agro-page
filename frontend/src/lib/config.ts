...
export const siteConfig = {
  name: 'Агро Сервіс',
  shortName: 'Мотоблок Сервіс',
  title: 'Агро Сервіс — Вспашка, целина і покос',
  description:
  ...
  /** Secondary phone shown under the lead form */
  phoneAlt: '+380679020326',
  phoneAltDisplay: '+38 (067) 902-03-26',
